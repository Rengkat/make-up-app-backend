...
const sendVerificationEmail = async ({ firstName, email, origin, verificationToken }) => {
  ...
  const message = `<p> Please confirm your email address by clicking the link below. 
  <a style={padding:'0.5rem 2rem';background:'purple';border-radius:'7px'} href=${link}>Verify your email address</a>
  </p>
